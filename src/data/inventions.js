          ...
          inventions: [
            ...
            },
            {
              ...
              sections: [
                  ...
                  { heading: "Engineering around it", body: "A competitor could retrain the model every time false positives are discovered or rely on simple confidence thresholds to suppress errors. Retraining is slow and expensive, while thresholding lacks specificity and may suppress valid detections." },
                  { heading: "Inferior result", body: "Without a targeted false-positive suppression mechanism, the system either generates too many false alerts (hurting customer experience) or becomes overly conservative (missing real issues), reducing overall effectiveness." },
                ]
            }
          ]
        }
