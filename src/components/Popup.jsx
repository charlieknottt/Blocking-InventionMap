...
const SEV_COLOR = { "Critical Blocker": "#dc2626", "Important Blocker": "#d97706", "Important Patent": "#2563eb" };
        ...
        <div className="max-h-[75vh] overflow-y-auto">
          <div className="px-7 pt-6 pb-7">
            ...
            <div className="flex items-start justify-between gap-4 mb-5">
              <div>
                <p className="text-[10px] font-bold uppercase tracking-[0.15em] mb-2" style={{ color: ring === "invention" && node.severity ? (SEV_COLOR[node.severity] || "#94a3b8") : "#94a3b8" }}>
